...
class TestApiBookReview(DoubanClientTestBase):
    ...
    def test_new_review_exception_book_id_v2(self):
        ...
        #pdb.set_trace()
        ret = self.client_v2.book.review.new(invalid_book_id, self.title,\
         self.content)
    ...
    def test_new_review_exception_title_v2(self): 
        ...
        ret = self.client_v2.book.review.new(self.book_id, invalid_title, \
            self.content)
        self.assertTrue(isinstance(ret, dict))
    ...
    def test_new_review_exception_content_v2(self):
        ...
        #pdb.set_trace()
        ret = self.client_v2.book.review.new(self.book_id, self.title, \
            invalid_content)
        self.assertTrue(isinstance(ret, dict))
    ...
    def test_update_review_exception_review_id_v2(self):  
        ...
        content = self.content * 2
        ret = self.client_v2.book.review.update(invalid_review_id, \
            self.title, content)
        self.assertTrue(isinstance(ret, dict))
    ...
    def test_update_review_exception_title_v2(self):
        ...
        # update
        invalid_title = self.title*200 # too long title
        ret = self.client_v2.book.review.update(review_id, invalid_title, \
            self.content)
        self.assertTrue(isinstance(ret, dict))
    ...
    def test_update_review_exception_content_v2(self):
        ...
        # update
        invalid_content = "TooShort" # too short content
        ret = self.client_v2.book.review.update(review_id, self.title, \
            invalid_content)
        try:
            self.assertTrue(isinstance(ret, dict))
            # check return string
